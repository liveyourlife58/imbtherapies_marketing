  ...
  const tests = [
    {
      ...
      icon: TestTube,
      color: '#5A6E8C',
      orderLink: 'https://test.imbtherapies.com/patient/product/33407'
    },
    {
      ...
      icon: Shield,
      color: '#68B04D',
      orderLink: 'https://test.imbtherapies.com/patient/product/33735'
    },
    {
      ...
      icon: Heart,
      color: '#5A6E8C',
      orderLink: 'https://test.imbtherapies.com/patient/product/33729'
    }
  ];
