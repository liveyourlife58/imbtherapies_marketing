...
export default function FoodSensitivityCompleteBlogPost() {
  const post = {
    ...
    content: `
      ...
      <p><a href="/portal/patient/product/33729" target="_blank" rel="noopener noreferrer" class="inline-block bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition-colors">Order Your Food Sensitivity Complete Test Today</a></p>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mt-16 p-8 rounded-2xl text-center" style={{ backgroundColor: 'rgba(90, 110, 140, 0.1)' }}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/portal/patient/product/33729"
              target="_blank"
