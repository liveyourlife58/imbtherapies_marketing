...
const blogPosts = {
  'vibrant-wellness-gut-zoomer-complete-guide': {
    ...
    content: `
      ...
      <p><a href="/patient/product/33407" target="_blank" rel="noopener noreferrer" class="inline-block bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition-colors">Order Your Gut Zoomer Test Kit Today</a></p>
