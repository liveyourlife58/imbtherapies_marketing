...
export default function WheatZoomerBlogPost() {
  const post = {
    ...
    content: `
      ...
      <p><a href="/patient/product/33735" target="_blank" rel="noopener noreferrer" class="inline-block bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition-colors">Order Your Wheat Zoomer Test Today</a></p>
